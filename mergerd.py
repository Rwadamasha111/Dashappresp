...
# Define the full app layout with multiple tabs
app.layout = html.Div([
    dcc.Tabs(id='tabs', value='tab-1', children=[
         dcc.Tab(label='Faces', value='tab-1', style=tab_style, selected_style=selected_tab_style),
         dcc.Tab(label='Objects', value='tab-2', style=tab_style, selected_style=selected_tab_style),
         dcc.Tab(label='NLP Transcript data', value='tab-3', style=tab_style, selected_style=selected_tab_style),
         dcc.Tab(label='Voice recognition', value='tab-4', style=tab_style, selected_style=selected_tab_style),
         dcc.Tab(label='Geo-Location', value='tab-5', style=tab_style, selected_style=selected_tab_style),
         dcc.Tab(label='DataFrames(source)', value='tab-6', style=tab_style, selected_style=selected_tab_style),
    ]),
    html.Div(id='main-content', style={'padding': '22px', 'backgroundColor': colors['background']})
])
...
def update_main_content(tab):
    if tab == 'tab-1':
         return add_image_to_tab(sheet1_content)  # your Faces tab content
    elif tab == 'tab-2':
         return add_image_to_tab(create_objects_tab())
    elif tab == 'tab-3':
         return add_image_to_tab(create_NLP_table())
    elif tab == 'tab-4':
         return add_image_to_tab(heat_map_tab())
    elif tab == 'tab-5':
         # Insert your geo app layout into tab-5
         return add_image_to_tab(tab_layout())
    else:
         return html.Div("Tab not found.", style={'textAlign': 'center', 'fontSize': '24px', 'color': 'gray'})
